...
- Zpět: navazuje na baseline/diff z [`../../day-2/staging-environments/`](../../day-2/staging-environments/) a governance artefakty (attestace, sprawl) z [`../opt-orchestry-integration/`](../opt-orchestry-integration/) —
