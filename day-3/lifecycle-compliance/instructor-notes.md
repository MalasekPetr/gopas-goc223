...
- Zpět: navazuje na baseline/diff z [`../../day-4/staging-environments/`](../../day-4/staging-environments/) a governance artefakty (attestace, sprawl) z [`../opt-orchestry-integration/`](../opt-orchestry-integration/) —
