...
> Typ: povinný · Den: 1 (otvírák) · Odhad: 120 min včetně 30 min rezervy na vícefaktorové ověření (MFA)
...
3. **Ověření role a přístupu** — student ověří přiřazenou licenci E5 a roli Global administrator (viz lab).
...
v kurzu jsme všichni Global administrator (GA) a chrání nás jen pravidla; v produkci je to přesně naopak.
...
- **Tenant Microsoft 365 (M365; zdarma, E5 Developer) vs Azure subscription (placená, oddělená)** — laby D4
...
> (program byl v roce 2024 omezen, obnova sandboxu závisí na aktivitě), přihlašovací rozhraní M365,
