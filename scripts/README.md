...
| 2. Studentské weby — **jen fallback** (studenti si `-dev/-test/-prod` weby vytváří sami v D1 labu) + seedování úmyslného driftu a demo obsahu do nich | `New-CourseStudentSites.ps1` `[PLÁNOVANÉ]` | PnP | `day-2/powershell-deep-dive`, `day-4/staging-environments` |
